  ...
  desde el panel) se instala por separado con odoo_mrp_planner_dispatch.
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'odoo_mrp_planner/static/src/js/planner_table.js',
            'odoo_mrp_planner/static/src/js/planner_selection.js',
            'odoo_mrp_planner/static/src/js/planner_multiselect.js',
            'odoo_mrp_planner/static/src/js/planner_export.js',
